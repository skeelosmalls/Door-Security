...
//on the ESP D3 is pin0 and is equal to pin 5 on reg arduino
...
byte mac[]    = {  0xDE, 0xED, 0xBA, 0xFE, 0xFE, 0xFE };  // mac     = Give Unique MAC address. (change the end of the mac by adding 1 letter.)
...
//      client.publish( ( char*) mqtt_text, WiFi.localIP());
